 ...
 * Supports CSV-based multi-language translations & built-in offline dictionaries.
 */
(function (window) {
    'use strict';

    // Built-in offline dictionaries (Instant loading, no network / CORS / fetch delay)
    ...
    class I18nManager {
        constructor() {
            ...
            this.availableLanguages = ['English', 'Arabic'];
            
            // Pre-load built-in English and Arabic dictionaries
            this.translations = {
                'English': Object.assign({}, BUILTIN_ENGLISH),
                'Arabic': Object.assign({}, BUILTIN_ARABIC)
            };
            this.listeners = [];
            this.initialized = false;

            // Check URL query parameter immediately ?lang=...
            ...
            // Immediately apply RTL settings if in document context
        ...
        loadCSV(csvString) {
            ...
            console.log('[i18n] CSV processed. Active language:', this.currentLanguage);
            this.applyLanguageSettings();
            this.applyTranslations();
        ...
        get(key, fallback = '', params = null) {
            ...
            let text = null;
            // 1. Try active language (e.g., Arabic)
